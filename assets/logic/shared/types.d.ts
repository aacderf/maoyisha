...
export type SkillTemplateType = "draw_bonus_on_turn_start" | "max_hp_bonus" | "heal_once_when_low";
...
export type CardKey = "sha" | "fire_sha" | "thunder_sha" | "shan" | "tao" | "jiu" | "wuzhong" | "guohe" | "shunshou" | "juedou" | "jiedao" | "nanman" | "wanjian" | "taoyuan" | "wugu" | "wuxie" | "lebu" | "shandian" | "huogong" | "tiesuo" | "bingliang" | "weapon" | "armor" | "attack_horse" | "defense_horse";
...
export type EquipmentKey = "zhuge" | "qinggang" | "hanbing" | "guding" | "zhuque" | "cixiong" | "qinglong" | "zhangba" | "guanshi" | "fangtian" | "qilin" | "bagua" | "renwang" | "tengjia" | "baiyin" | "dilu" | "jueying" | "zhuahuang" | "chitu" | "dayuan" | "zixing";
...
export type GamePhase = "opening" | "prepare" | "judge" | "draw" | "play" | "discard" | "finish" | "response" | "dying" | "finished";
...
export interface PendingChoice {
    id: string;
    kind: "target-card" | "public-card" | "target-seat" | "multi-target-seat" | "multi-card" | "discard-suit" | "opening-identity" | "sha-transfer" | "huogong-reveal" | "skill-target" | "skill-option" | "skill-confirm";
